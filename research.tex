...
%---------------------------------------------------------
  \paperentry
    ...
    { Proceedings of the 2017 Network and Distributed System Security Symposium (\textbf{NDSS 2017}, Acceptance ratio: 68/423=16.1\%) } % Date(s)
    {
  ...
  \paperentry
    ...
    { Proceedings of the 2016 Network and Distributed System Security Symposium (\textbf{NDSS 2016}, Acceptance ratio: 60/389=15.4\%) } % Date(s)
    {
        \begin{cvitems} % Description(s)
